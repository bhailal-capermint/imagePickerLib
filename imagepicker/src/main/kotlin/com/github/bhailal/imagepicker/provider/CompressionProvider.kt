package com.github.bhailal.imagepicker.provider
...
import com.github.bhailal.imagepicker.ImagePickerActivity
import com.github.bhailal.imagepicker.util.ExifDataCopier
import com.github.bhailal.imagepicker.util.FileUtil
import com.github.bhailal.imagepicker.util.ImageUtil
import java.io.File
        ...
        object : AsyncTask<Uri, Void, File>() {
            ...
            override fun onPostExecute(file: File?) {
                ...
                if (file != null) {
                    ...
                    // Post Error
                    setError(com.github.bhailal.imagepicker.R.string.error_failed_to_compress_image)
                }
            }
        }.execute(uri)
    }
