package com.github.bhailal.imagepicker
...
import com.github.bhailal.imagepicker.listener.DismissListener
import com.github.bhailal.imagepicker.listener.ResultListener
import com.github.bhailal.imagepicker.util.BottomSheetHelperFragment
import com.github.bhailal.imagepicker.util.DialogHelper
import java.io.File
...
open class ImagePicker {
    ...
    class Builder(private val activity: Activity) {
        ...
        fun isDialog(): Builder {
            imageChooser = 0
            return this
        }

        fun isBottomSheet(): Builder {
            imageChooser = 1
            return this
        }
        ...
        fun start(reqCode: Int) {
            if (imageProvider == ImageProvider.BOTH) {
                when (imageChooser) {
                    ...
                    1 -> {
                        showImageProviderBottomSheet(reqCode)
                    }
                    else -> {
                        showImageProviderDialog(reqCode)
                    }
         ...
         * Pick Image Provider if not specified
         */
        private fun showImageProviderBottomSheet(reqCode: Int) {
            BottomSheetHelperFragment.showDialog(fragment?.parentFragmentManager!!) {
                imageProvider = it
                imageProviderInterceptor?.invoke(imageProvider)
                startActivity(reqCode)
